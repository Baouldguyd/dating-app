const DrawingIcon = () => {
  return (
    ...
    >
      <rect width="30" height="30" fill="url(#pattern0_2197_503)" />
      <defs>
        <pattern
          id="pattern0_2197_503"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use xlinkHref="#image0_2197_503" transform="scale(0.01)" />
        </pattern>
        <image
          id="image0_2197_503"
          width="100"
